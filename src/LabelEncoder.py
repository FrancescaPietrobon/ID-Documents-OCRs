...
from utilities.utils import compute_iou
...
class LabelEncoder:
    ...
    def _match_anchor_boxes(
        self, anchor_boxes, gt_boxes, match_iou=0.45, ignore_iou=0.3
    ):
    ...
    def encode_batch(self, batch_images, gt_boxes, cls_ids):
        ...
        return batch_images, tf.convert_to_tensor(labels, dtype=tf.float32)
